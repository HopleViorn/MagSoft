...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon6 = QtGui.QIcon()
        icon6.addPixmap(QtGui.QPixmap(":/icons/icons/icons8-drafting-compass-100.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.calibration_length.setIcon(icon6)
        ...
        self.calibration_magfiled.setIcon(icon6)
        ...
        icon9 = QtGui.QIcon()
        icon9.addPixmap(QtGui.QPixmap(":/icons/icons/icons8-analysis-100.png"), QtGui.QIcon.Normal, QtGui.QIcon.Off)
        self.initBtn.setIcon(icon9)
        self.initBtn.setIconSize(QtCore.QSize(30, 30))
        self.initBtn.setObjectName("initBtn")
        self.initializeLabel = InitializeLabel(self.groupBox_2)
        self.initializeLabel.setEnabled(True)
        self.initializeLabel.setGeometry(QtCore.QRect(20, 170, 141, 51))
        ...
        self.length_info = LengthLabel(self.groupBox_4)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Preferred, QtWidgets.QSizePolicy.Expanding)
        sizePolicy.setHorizontalStretch(0)
        ...
        self.verticalLayout_8.addWidget(self.length_info)
